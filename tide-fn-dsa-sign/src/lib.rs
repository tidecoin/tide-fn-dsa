...
use core::fmt;
use tide_fn_dsa_comm::{codec, hash_to_point, hash_to_point_falcon, mq, shake, PRNG};
    ...
    impl SigningKey for $typename {
        ...
        fn decode(src: &[u8]) -> Option<Self> {
            ...
            let mut sk = Self {
                ...
                logn: 0,
                #[cfg(all(not(feature = "no_avx2"), target_arch = "x86_64"))]
                use_avx2: tide_fn_dsa_comm::has_avx2(),
            };
...
pub(crate) mod tests {
    ...
    #[cfg(feature = "shake256x4")]
    pub(crate) use tide_fn_dsa_comm::shake::SHAKE256x4;
    ...
    #[cfg(not(feature = "shake256x4"))]
    impl tide_fn_dsa_comm::PRNG for SHAKE256x4 {
